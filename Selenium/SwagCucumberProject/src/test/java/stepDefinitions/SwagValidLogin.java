...
public class SwagValidLogin 
{
	...
	public void the_user_is_on_the_swag_login_page() throws InterruptedException 
	{
	...
	public void the_user_should_see_a_products_page() throws InterruptedException 
	{
		...
		String actualUrl=driver.getCurrentUrl();
		 ...
		 Assert.assertEquals("The user is not on the Products page", expectedUrl, actualUrl);
			Thread.sleep(2000);
